	...
	function cpotheme_custom_fields($cpo_options, $list_name){    
		...
		foreach($cpo_options as $current_field){
			...
			if($field_type == 'separator'){
				if($tab_count > 0):
					$output .= '<input class="cpothemes-submit button-primary" type="submit" name="cpotheme_settings_save" value="'.__('Save Settings', 'cpocore').'" />';
					$output .= '</div>';
				endif;
	...
	function cpotheme_custom_header(){
		...
		<div class="cpothemes-header">
			...
			<div class="cpothemes-header-meta">
				...
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a target="_blank" href="http://themeforest.net/user/cpothemes?ref=cpothemes"><?php _e('More Themes', 'cpocore'); ?></a>
			</div>
			<!--<div class="cpothemes-header-social">
...
if(!function_exists('cpotheme_custom_support')){
	function cpotheme_custom_support(){
		...
		$output .= '<a target="_blank" href="http://www.cpothemes.com/documentation">'.__('Theme Documentation', 'cpocore').'</a>';
		$output .= '&nbsp;&nbsp;|&nbsp;&nbsp;';
		$output .= '<a target="_blank" href="http://www.cpothemes.com/forums">'.__('Support Forum', 'cpocore').'</a>';
		$output .= '</div>';
		return $output;
	}
}
