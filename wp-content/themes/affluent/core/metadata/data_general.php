...
if(!function_exists('cpotheme_metadata_fonts_name')){
	function cpotheme_metadata_font_sizes($key = null){
		$cpotheme_data = array(
		'0.875' => __('Normal', 'cpocore'),
		'0.8' => __('Small', 'cpocore'),
		'1' => __('Medium', 'cpocore'),
		'1.125' => __('Large', 'cpocore'));
		return $key == null ? $cpotheme_data : $cpotheme_data[$key];
	}
}
...
if(!function_exists('cpotheme_metadata_fonts_name')){
	function cpotheme_metadata_fonts_name($name){
		return str_replace(array(' (Light)', ' (Bold)'), '', cpotheme_metadata_fonts($name));
	}
}
...
function cpotheme_metadata_sidebarposition(){
	...
	if(defined('CPO_CORE_URL')) $core_path = CPO_CORE_URL;
	$cpotheme_data = array(
...
function cpotheme_metadata_page_header(){
	$cpotheme_data = array(
	'normal' => __('Normal Header', 'cpocore'),
	'minimal' => __('Minimal Header', 'cpocore'),
	'none' => __('No Header', 'cpocore'));
	return $cpotheme_data;
}
...
function cpotheme_metadata_page_title(){
	$cpotheme_data = array(
	'normal' => __('Normal Title', 'cpocore'),
	'minimal' => __('Minimal Title', 'cpocore'),
	'none' => __('No Title', 'cpocore'));
	return $cpotheme_data;
}
...
function cpotheme_metadata_page_footer(){
	$cpotheme_data = array(
	'normal' => __('Normal Footer', 'cpocore'),
	'minimal' => __('Minimal Footer', 'cpocore'),
	'none' => __('No Footer', 'cpocore'));
	return $cpotheme_data;
}
