...
function cpotheme_styling_css(){ 
	...
	$type_headings = cpotheme_get_option('type_headings');
	$type_nav = cpotheme_get_option('type_nav');
	$type_body = cpotheme_get_option('type_body');
...
function cpotheme_styling_fonts(){ 
	cpotheme_fonts(cpotheme_get_option('type_headings'));
	cpotheme_fonts(cpotheme_get_option('type_nav')); 
	cpotheme_fonts(cpotheme_get_option('type_body'), cpotheme_get_option('type_body_variants'));
}
